...
int aes_decrypt_cbc(const BYTE in[], size_t in_len, BYTE out[], const AES_WORD key[], int keysize,
                    const BYTE iv[]);
...
int aes_encrypt_ccm(
    ...
    const BYTE
        associated_data[], // IN  - Associated Data included in authentication, but not encryption.
